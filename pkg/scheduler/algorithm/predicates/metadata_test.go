...
func predicateMetadataEquivalent(meta1, meta2 *predicateMetadata) error {
	...
	sortTopologyPairs(meta1.topologyPairsAntiAffinityPodsMap.antiAffinityPodToTopologyPairs)
	sortTopologyPairs(meta2.topologyPairsAntiAffinityPodsMap.antiAffinityPodToTopologyPairs)
	if !reflect.DeepEqual(meta1.topologyPairsAntiAffinityPodsMap.antiAffinityPodToTopologyPairs,
		meta2.topologyPairsAntiAffinityPodsMap.antiAffinityPodToTopologyPairs) {
		return fmt.Errorf("topologyPairsAntiAffinityPodsMap.antiAffinityPodToTopologyPairs are not equal")
	}
	sortTopologyPairPods(meta1.topologyPairsAntiAffinityPodsMap.topologyPairToAntiAffinityPods)
	sortTopologyPairPods(meta2.topologyPairsAntiAffinityPodsMap.topologyPairToAntiAffinityPods)
	if !reflect.DeepEqual(meta1.topologyPairsAntiAffinityPodsMap.topologyPairToAntiAffinityPods,
		meta2.topologyPairsAntiAffinityPodsMap.topologyPairToAntiAffinityPods) {
